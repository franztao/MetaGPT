...
requirements = r'当前运行环境是linux，当前FlagPerf的git库地址在"/home/hengtao/debug/step2/FlagPerf",数据和模型地址在"/home/hengtao/code/task/llama3_8B/megatron_llama3/data_dir",参考的模板地址是“/home/hengtao/debug/step2/FlagPerf/training/nvidia/llama3_8B-megatron/config/config_A100x1x8.py”,magatron的地址是“/workspace/Megatron-LM”,调用工具一定不要有删除卸载等高危操作'
